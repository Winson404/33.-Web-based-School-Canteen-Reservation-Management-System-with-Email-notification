...
<div class="row d-flex justify-content-center content m-5">
  <div class="div.col-lg-8">
    <?php 
      if(isset($_GET['prod_Id']) && isset($_GET['reserve_Id'])) {
           ...
           <!--  <div class="mt-4">
              <form action="../forms/reservation_create.php" method="POST">
                <div class="d-flex justify-content-between align-items-center">
                  <button type="submit" class="btn btn-primary btn-lg btn-flat" name="reserve_button_include_reserve_Id"><i class="fas fa-cart-plus fa-lg mr-2"></i> Reserve</button>
                  <input type="hidden" class="form-control text-center" value="<?php //$id; ?>" required name="cust_Id">
                  <input type="hidden" class="form-control text-center" value="<?php //$row['prod_Id']; ?>" required name="prod_Id">
                  <input type="hidden" class="form-control text-center" value="<?php //$reserve_Id; ?>" required name="reserve_Id">
                  <input type="number" min="1" class="form-control form-control-lg text-center" placeholder="qty" style="width: 90px;" name="qty" required>
                </div>
              </form> -->
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6">
            ...
            <div class="mt-4">
              <form action="../forms/reservation_create.php" method="POST">
                <div class="d-flex justify-content-between align-items-center">
                  <button type="submit" class="btn btn-primary btn-lg btn-flat" name="reserve_button"><i class="fas fa-cart-plus fa-lg mr-2"></i> Reserve</button>
