        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">GCash Payment Details</h5>
            </div>
            <div class="card-body">
                <img src="../assets/images/gcash.jpg" alt="GCash Logo" class="img-fluid mb-3">
                ...
                <div class="mb-3">
                    <strong>GCash #:</strong>
                    <span class="text-muted">09123456789</span>
                </div>

                <div class="mb-3">
                    <strong>Account Holder:</strong>
                    <span class="text-muted">J**n D**</span>
                </div>

                <p class="card-text text-muted">To complete your food reservation, please transfer the total amount to the GCash account provided above. Make sure to include your order details in the payment reference.</p>
            </div>
